...
async function runCoreMigrations(client) {
  ...
  await client.query(`
    CREATE TABLE IF NOT EXISTS attestations (
      ...
      reviewer_id INTEGER REFERENCES reviewers(id), action VARCHAR(20), notes TEXT, signature TEXT, created_at TIMESTAMPTZ DEFAULT NOW()
    )
  `);

  // Ensure notes and signature columns exist on attestations (schema drift safety)
  await client.query(`
